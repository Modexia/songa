...
export function StatsSection() {
    return (
        <section className="py-12 sm:py-16 lg:py-20 relative overflow-hidden bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/src/images/featureIMG.jpg)' }}>
