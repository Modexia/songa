  ...
  return (
    <footer className="bg-[#0A0F1E] relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        {/* Newsletter CTA bar */}
        <div className="bg-gradient-to-r from-[#006072] to-[#004d5b] rounded-2xl p-6 sm:p-8 mb-14 flex flex-col sm:flex-row items-center gap-6 border border-white/10 shadow-2xl">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <input
              ...
              className="flex-1 sm:w-64 px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/40 text-sm focus:outline-none focus:border-[#FF6B35] transition-colors"
            />
            <button className="flex-shrink-0 px-5 py-3 bg-[#FF6B35] hover:bg-[#e85d2a] text-white rounded-xl font-semibold text-sm transition-all hover:shadow-lg hover:shadow-orange-500/30 flex items-center gap-2">
